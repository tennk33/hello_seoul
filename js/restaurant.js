...
// 서울 맛집 정보
var url = 'http://api.visitkorea.or.kr/openapi/service/rest/KorService/areaBasedList?serviceKey=LWnkTPaCBnQUhdORFm%2BbIF2gt29K%2BWC%2FwZm8pAYgn7%2Fnvf4G7mpOJZzRYKHQc3XI1%2BmDEQoolHxZvmM774aFnw%3D%3D&pageNo=1&numOfRows=8&MobileApp=AppTest&MobileOS=ETC&arrange=A&contentTypeId=39&areaCode=1&listYN=Y';
...
$.ajax({
    ...
    success : function(data) {
        var restaurant = data;
        $('#article_0').append($('.img0').attr('src',restaurant.response.body.items.item[0].firstimage));
        $('#article_0 h2').text(''+restaurant.response.body.items.item[0].title+'');

        $('#article_1').append($('.img1').attr('src',restaurant.response.body.items.item[1].firstimage));
        $('#article_1 h2').text(''+restaurant.response.body.items.item[1].title+'');

        $('#article_2').append($('.img2').attr('src',restaurant.response.body.items.item[2].firstimage));
        $('#article_2 h2').text(''+restaurant.response.body.items.item[2].title+'');

        $('#article_3').append($('.img3').attr('src',restaurant.response.body.items.item[3].firstimage));
        $('#article_3 h2').text(''+restaurant.response.body.items.item[3].title+'');

        $('#article_4').append($('.img4').attr('src',restaurant.response.body.items.item[4].firstimage));
        $('#article_4 h2').text(''+restaurant.response.body.items.item[4].title+'');

        $('#article_5').append($('.img5').attr('src',restaurant.response.body.items.item[5].firstimage));
        $('#article_5 h2').text(''+restaurant.response.body.items.item[5].title+'');

        $('#article_6').append($('.img6').attr('src',restaurant.response.body.items.item[6].firstimage));
        $('#article_6 h2').text(''+restaurant.response.body.items.item[6].title+'');

        $('#article_7').append($('.img7').attr('src',restaurant.response.body.items.item[7].firstimage));
        $('#article_7 h2').text(''+restaurant.response.body.items.item[7].title+'');    
...
$.ajax({
    ...
    $('#article_0 > .open_modal').on('click',function(){
        ...
        var addr1 = restaurant.response.body.items.item[0].addr1;
    ...
    $('#article_1 > .open_modal').on('click',function(){
        ...
        var addr1 = restaurant.response.body.items.item[1].addr1;
    ...
    $('#article_2 > .open_modal').on('click',function(){
        ...
        var addr1 = restaurant.response.body.items.item[2].addr1;
    ...
    $('#article_3 > .open_modal').on('click',function(){
        ...
        var addr1 = restaurant.response.body.items.item[3].addr1;
    ...
    $('#article_4 > .open_modal').on('click',function(){
        ...
        var addr1 = restaurant.response.body.items.item[4].addr1;
    ...
    $('#article_5 > .open_modal').on('click',function(){
        ...
        var addr1 = restaurant.response.body.items.item[5].addr1;
    ...
    $('#article_6 > .open_modal ').on('click',function(){
        ...
        var addr1 = restaurant.response.body.items.item[6].addr1;
    ...
    $('#article_7 > .open_modal ').on('click',function(){
        ...
        var addr1 = restaurant.response.body.items.item[7].addr1;
